...
export default function Hero() {
    return(
        <Draggable cancel="button">
            <div className={`absolute top-20 left-[300px] flex max-h-screen min-h-[35vh] h-auto flex-col w-[30vw] min-w-[600px] items-center justify-start gap-2 border-[1px] border-l-white border-t-white border-r-black border-b-black bg-[#CED0CF] px-1 text-left`}>
                <div className="mb-1 mt-1 min-w-[395px] w-full h-[5vh] bg-[#070C80] flex flex-row justify-between items-center pl-4 pr-2">
                    <div className="flex flex-row justify-center items-center gap-2">
                        ...
                        <span className="text-white text-lg">ThumbPedia <span className="text-[12px]">(wip)</span></span>
                    </div>
                ...
                <div className="w-full px-6">
                    ...
                    <div className="text-md">
                        {`A place to see all high performing Thumbnails, by niche, geography, channel and whatever else your heart desires :)`}
                        <p className="mt-2">
